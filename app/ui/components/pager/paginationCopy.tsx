...
const FirstButton = React.forwardRef<ButtonElement, ButtonProps>(
  ({ count, currentPage, className, ...rest }, ref) => {
...
const NextButton = React.forwardRef<ButtonElement, ButtonProps>(
  ({ count, currentPage, className, children, ...rest }, ref) => {
    const classes = twMerge(
      cx(
        'previous  py-2 px-3 leading-tight border',
        'border-slate-300 bg-white text-slate-500 hover:bg-slate-100 hover:text-slate-700',
...
const Pages = React.forwardRef<RootElement, RootProps>(
...
export const Pagination = ({
  ...
  return (
    <Pagination.Root className={className}>
      <li>
        <Pagination.First count={count} currentPage={currentPage} />
      </li>
      <li>
        <Pagination.Prev count={count} currentPage={currentPage} />
      </li>
      ...
      <li>
        <Pagination.Next count={count} currentPage={currentPage} />
      </li>
      <li>
        <Pagination.Last count={count} currentPage={currentPage} />
      </li>
    </Pagination.Root>
  )
}
