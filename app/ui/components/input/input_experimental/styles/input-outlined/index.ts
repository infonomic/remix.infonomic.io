import inputOutlinedIntent from './input-outlined-intent'
import inputOutlinedLabel from './input-outlined-label'
import inputOutlinedLabelIntent from './input-outlined-label-intent'
...
const inputOutlined = {
  ...
  intent: {
    input: inputOutlinedIntent,
    label: inputOutlinedLabelIntent,
  },
  error: {
    input: {
      borderColor:
